...
#
# Here we plot heatmaps of our rhythmic phosphopeptides
# This is to make sure that our data processing methods hitherto look sensible by eye!
# We sort the phosphopeptides by phase to make the plots have some sense, and to eye-ball for any phase patterns
#
# INPUTS = normalised data for rhythmic phosphopeptides (.csv)
